...
export default function CartPage() {
  ...
  return (
    <div className="container py-12">
      <h1 className="font-display text-5xl text-brown-ink mb-10">{t("cart.title")}</h1>
      <div className="grid lg:grid-cols-[1fr_360px] gap-10">
        ...
        <aside className="bg-brown-ink text-cream p-8 h-fit vinyl-shadow">
          ...
          <dl className="space-y-2 text-sm">
            <div className="flex justify-between"><dt>{t("common.subtotal")}</dt><dd>{formatCOP(total)}</dd></div>
            <div className="flex justify-between"><dt>{t("common.shipping")}</dt><dd className="italic text-mustard">{t("cart.shippingCalc")}</dd></div>
          </dl>
